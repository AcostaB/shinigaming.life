...
export const Actions = {
  decreaseLimitedUse: (id: number) =>
    createAction(dndActions.DECREASE_LIMITED_USE, id),
  increaseLimitedUse: (id: number) =>
    createAction(dndActions.INCREASE_LIMITED_USE, id),
  shortRest: () => createAction(dndActions.SHORT_REST),
  longRest: () => createAction(dndActions.LONG_REST),
  toogleInventoryTab: (inventoryActive: boolean) =>
    createAction(dndActions.TOGGLE_INVENTORY_TAB, inventoryActive),
